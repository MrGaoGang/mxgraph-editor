        ...
        <Tooltip placement="top" title={userGuideText}>
          <div
            ...
            onClick={() => {
              ...
              const { cellsGrouped } = editor.groupCells(
                cellsSelected,
                groupName
              );
